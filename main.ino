...
#define LCD_RD A0 
#define LCD_RESET A4 
// need some calibration first. use the example: touchscreen --> touchscreendemo
// then click the top left corner
// then click the bottom right corner
// the serial monitor will print the coordinates to the screen, copy then and put them in the following constants.
#define TS_MINX 122
#define TS_MINY 111
#define TS_MAXX 942
#define TS_MAXY 890
